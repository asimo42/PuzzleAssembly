...
public:
	...
	void setStartTimeToNow() { this->timeStarted = this->timeStarted.Now; } // tell GamePlayed to pull the current date/time to record as start time
	void setTimeCompletedToNow() { this->timeCompleted = this->timeCompleted.Now; }
